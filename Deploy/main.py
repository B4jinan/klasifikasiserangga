...
TOPK = 3
TH_TOP1 = 0.55      # jika top-1 < 0.55 → tidak teridentifikasi
TH_MARGIN = 0.15    # jika (top1-top2) < 0.15 → tidak teridentifikasi
TH_ENTROPY = 1.30   # jika entropi > 1.30 (ln(7)≈1.95) → tidak teridentifikasi
